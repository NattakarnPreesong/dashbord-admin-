        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              id="customer"
              name="customerId"
              className="peer block w-full cursor-pointer rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500 shadow-md"
          ...
          <div className="rounded-md border border-gray-200 bg-white px-[14px] py-3 shadow-md">
            <div className="flex gap-4">
              <div className="flex items-center">
                ...
                <label
                  htmlFor="pending"
                  className="ml-2 flex cursor-pointer items-center gap-1.5 rounded-full bg-gray-100 px-3 py-1.5 text-xs font-medium text-gray-600 shadow-md"
                >
